<div class="modal animated zoomIn" id="invoice-delete-modal">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer justify-content-end">
                <div>
                    ...
                    <button onclick="invoiceDelete()" type="button" id="confirmDelete" class="btn bg-gradient-danger" >Delete</button>
                </div>
            </div>
        </div>
    </div>
