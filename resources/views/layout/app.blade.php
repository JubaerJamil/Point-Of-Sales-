...
<script src="{{ asset('js/jquery-datatable.min.js') }}"></script>
  ...
  <body class="g-sidenav-show  bg-gray-100">
    ...
    <a class="navbar-brand m-0" href="{{ url('/sales-summary') }}">
    ...
    <li class="nav-item mb-2 mt-0">
        ...
        aria-expanded="false">
          ...
          <p class="nav-link-text ms-2 ps-1" id="myName">User Profile</p>
        </a>
...
<div class="collapse show" id="dashboardsExamples" style="">
    ...
    <ul class="nav ">
    <li class="nav-item ">
      <a class="nav-link text-white link-success" href="{{ url('/category-page') }}">
    ...
    <div class="collapse show" >
        <ul class="nav">
        <li class="nav-item ">
          <a class="nav-link text-white link-success " href="{{ url('/customer-page') }}">
    ...
    <div class="collapse show" >
        <ul class="nav ">
        <li class="nav-item ">
          <a class="nav-link text-white link-success " href="{{ url('/product-page') }}">
    ...
    <div class="collapse show" >
        <ul class="nav ">
        <li class="nav-item ">
          <a class="nav-link text-white link-success" href="{{ url('/invoice-page') }}">
            <span class="sidenav-mini-icon"> D </span>
            <span class="sidenav-normal  ms-2  ps-1"> Create Sale </span>
                </a>
            </li>
        </ul>
    </div>
    ...
    <div class="collapse show" >
        <ul class="nav ">
        <li class="nav-item ">
          <a class="nav-link text-white link-success" href="{{ url('/invoice-list') }}">
            <span class="sidenav-mini-icon"> E </span>
            <span class="sidenav-normal  ms-2  ps-1"> Invoice List </span>
                </a>
            </li>
        </ul>
    </div>
    ...
    <div class="collapse show" >
        <ul class="nav ">
        <li class="nav-item ">
          <a class="nav-link text-white link-success" href="{{ url('/sales-summary') }}">
            <span class="sidenav-mini-icon"> F </span>
            <span class="sidenav-normal  ms-2  ps-1"> Summary Report </span>
                </a>
            </li>
        </ul>
    </div>
    ...
    <div class="collapse show" >
        <ul class="nav ">
        <li class="nav-item ">
          <a class="nav-link text-white link-success" href="{{ url('/report-download') }}">
            <span class="sidenav-mini-icon"> G </span>
            <span class="sidenav-normal  ms-2  ps-1"> Report Download</span>
                </a>
            </li>
        </ul>
    </div>
